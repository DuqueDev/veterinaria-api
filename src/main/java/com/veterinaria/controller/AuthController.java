...
public class AuthController {
  ...
  public ResponseEntity<?> userSignup(@Valid @RequestBody SignupRequest signupRequest) {
    ...
    //Si no se le envia un Rol por defecto va USER
    if(roleArr == null) {
